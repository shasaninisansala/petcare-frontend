        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/login" className="text-sm text-green-600 hover:text-green-700 font-medium border border-green-600 px-4 py-2 rounded-lg hover:bg-green-50 transition">
                Log in
              </Link>
            </div>
          </div>
        ...
        <main className="max-w-3xl mx-auto px-6 py-12">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-4 rounded-lg transition duration-200 mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
            ...
            <button
              ...
              disabled={loading}
              className="w-full text-gray-600 hover:text-gray-800 font-medium py-2 flex items-center justify-center gap-2 transition disabled:opacity-50"
            >
